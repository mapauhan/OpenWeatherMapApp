...
extension ViewController: UITableViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "currentWeatherSegue" {
            ...
            destinationVC.API_KEY = API_KEY
            destinationVC.BASE_URL = BASE_URL
            destinationVC.selectedCountry = self.c
            destinationVC.selectedCity = self.d
        }
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // what country?
        self.c = countries[indexPath.section]
        //cities in country
        let citiesInCountry = data[self.c!]
        //what city?
        self.d = citiesInCountry![indexPath.row] //prints data to tableview
        print("Selected row\(self.c!, self.d!)")
